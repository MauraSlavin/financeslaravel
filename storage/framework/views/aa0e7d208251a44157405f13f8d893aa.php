<html>
    ...
    <body>
        ...
        <h1>Transactions loaded for 
            <span id="accountName"><?php echo e($accountName); ?></span>
        </h1>
        <h3>Cleared balance: <?php echo e($clearedBalance); ?></h3>
        <h3>Register balance: <?php echo e($registerBalance); ?></h3>
        <h3>Last Balanced: <?php echo e($lastBalanced); ?></h3>
        <?php if($upload): ?>
        ...
        <?php endif; ?>
        <input type="hidden" id="accountNames"  name="accountNames"  value=<?php echo e(json_encode($accountNames)); ?>>
        <input type="hidden" id="toFroms"       name="toFroms"       value=<?php echo e($toFroms); ?>>
        <input type="hidden" id="toFromAliases" name="toFromAliases" value=<?php echo e($toFromAliases); ?>>
        <input type="hidden" id="categories"    name="categories"    value=<?php echo e($categories); ?>>
        <input type="hidden" id="trackings"     name="trackings"     value=<?php echo e($trackings); ?>>
        <input type="hidden" id="buckets"       name="buckets"       value=<?php echo e($buckets); ?>>

        <form>
            <div class="mb-3">
                <label for="beginDate" class="form-label">Select Begin and End Dates:</label>
                <div class="d-flex">
                    <input type="text" class="form-control" id="beginDate" placeholder="Begin (m/d/y or m/d)" value=<?php echo e($beginDate); ?>>
                    -
                    <input type="text" class="form-control" id="endDate" placeholder="End (m/d/y or m/d)" value=<?php echo e($endDate); ?>>
        ...
        <table id="editTransactionsTable">
            ...
            <thead>
                <tr>
                    ...
                    <th>total_amt</th>
                    <th>total_key</th>
                    <?php if($accountName == 'DiscSavings' || $accountName == 'all'): ?>
                        <th>bucket</th>
                    <?php endif; ?>
                    <th>notes</th>
                    <th>lastBalanced</th>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $newTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newTransaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id=<?php echo e($newTransaction["id"]); ?> 
                        <?php if($newTransaction["dupMaybe"]): ?> 
                            class="dupMaybe" 
                        <?php endif; ?>
                    >
                        <td class="newtransaction"><?php echo e($newTransaction["id"] ?? NULL); ?></td>
                        <td class="transDate"><?php echo e($newTransaction["trans_date"] ?? NULL); ?></td>
                        <td class="clearDate"><?php echo e($newTransaction["clear_date"] ?? NULL); ?></td>
                        <?php if($accountName == 'all'): ?>
                            <td class="account"><?php echo e($newTransaction["account"] ?? NULL); ?></td>
                        <?php endif; ?>
                        <td class="toFrom"><?php echo e($newTransaction["toFrom"] ?? NULL); ?></td>
                        <td class="amount"><?php echo e($newTransaction["amount"] ?? NULL); ?></td>
                        <td class="amtMike"><?php echo e($newTransaction["amtMike"] ?? NULL); ?></td>
                        <td class="amtMaura"><?php echo e($newTransaction["amtMaura"] ?? NULL); ?></td>
                        <td class="method"><?php echo e($newTransaction["method"] ?? NULL); ?></td>
                        <td class="category"><?php echo e($newTransaction["category"] ?? NULL); ?></td>
                        <td class="tracking"><?php echo e($newTransaction["tracking"] ?? NULL); ?></td>
                        <td class="stmtDate"><?php echo e($newTransaction["stmtDate"] ?? NULL); ?></td>
                        <td class="total_amt"><?php echo e($newTransaction["total_amt"] ?? NULL); ?></td>
                        <td class="total_key"><?php echo e($newTransaction["total_key"] ?? NULL); ?></td>
                        <?php if($accountName == 'DiscSavings' || $accountName == 'all'): ?>
                            <td class="bucket"><?php echo e($newTransaction["bucket"] ?? NULL); ?></td>
                        <?php endif; ?>
                        <td class="notes"><?php echo e($newTransaction["notes"] ?? NULL); ?></td>
                        <td class="lastBalanced"></td>
                        <td class="spent"><?php if(isset($newTransaction["spent"])): ?><?php echo e($newTransaction["spent"]); ?>

                                          <?php else: ?> - 
                                          <?php endif; ?>
                        </td>
                        <td class="ytmBudget"><?php if(isset($newTransaction["ytmBudget"])): ?><?php echo e($newTransaction["ytmBudget"]); ?>

                                          <?php else: ?> - 
                                          <?php endif; ?>
                        </td>
                        <td class="yearBudget"><?php if(isset($newTransaction["yearBudget"])): ?><?php echo e($newTransaction["yearBudget"]); ?>
                        ...
                        <td>
                            <button id="editTransaction" class="btn btn-primary" data-id=<?php echo e($newTransaction["id"]); ?>>Edit</button>
                        </td>
                        <td>
                            <button id="splitTransaction" class="btn btn-warning" data-id=<?php echo e($newTransaction["id"]); ?>>Split</button>
                        </td>                       
                        <td>
                            <button id="deleteTransaction" class="btn btn-danger" data-id=<?php echo e($newTransaction["id"]); ?>>Delete</button>
                        </td>
                    </tr>
                ...
                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr data-id=<?php echo e($transaction->id); ?>>
                        <td class="transId"><?php echo e($transaction->id); ?></td>
                        <td class="transDate"><?php echo e($transaction->trans_date); ?></td>
                        <td class="clearDate"><?php echo e($transaction->clear_date); ?></td>
                        <?php if($accountName == 'all'): ?>
                            <td class="account"><?php echo e($transaction->account); ?></td>
                        <?php endif; ?>
                        <td class="toFrom"><?php echo e($transaction->toFrom); ?></td>
                        <td class="amount"><?php echo e($transaction->amount); ?></td>
                        <td class="amtMike"><?php echo e($transaction->amtMike); ?></td>
                        <td class="amtMaura"><?php echo e($transaction->amtMaura); ?></td>
                        <td class="method"><?php echo e($transaction->method); ?></td>
                        <td class="category"><?php echo e($transaction->category); ?></td>
                        <td class="tracking"><?php echo e($transaction->tracking); ?></td>
                        <td class="stmtDate"><?php echo e($transaction->stmtDate); ?></td>
                        <td class="total_amt"><?php echo e($transaction->total_amt); ?></td>
                        <td class="total_key"><?php echo e($transaction->total_key); ?></td>
                        <?php if($accountName == 'DiscSavings' || $accountName == 'all'): ?>
                            <td class="bucket"><?php echo e($transaction->bucket); ?></td>
                        <?php endif; ?>
                        <td class="notes"><?php echo e($transaction->notes); ?></td>
                        <td class="lastBalanced"><?php echo e($transaction->lastBalanced ? substr($transaction->lastBalanced, 0, 10) : NULL); ?></td>
                        <td class="spent"><?php if(isset($transaction->spent)): ?><?php echo e($transaction->spent); ?>

                                          <?php else: ?> - 
                                          <?php endif; ?>
                        </td>
                        <td class="ytmBudget"><?php if(isset($transaction->ytmBudget)): ?><?php echo e($transaction->ytmBudget); ?>

                                          <?php else: ?> - 
                                          <?php endif; ?>
                        </td>
                        <td class="yearBudget"><?php if(isset($transaction->yearBudget)): ?><?php echo e($transaction->yearBudget); ?>
                        ...
                        <td>
                            <button id="editTransaction" class="btn btn-primary" data-id=<?php echo e($transaction->id); ?>>Edit</button>
                        </td>                       
                        <td>
                            <button id="splitTransaction" class="btn btn-warning" data-id=<?php echo e($transaction->id); ?>>Split</button>
                        </td>                       
                        <td>
                            <button id="deleteTransaction" class="btn btn-danger" data-id=<?php echo e($transaction->id); ?>>Delete</button>
                        </td>                       
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '#editTransaction', function(e) {
                    ...
                    if (origAccount == '') origAccount = "<?php echo e($accountName); ?>";
                ...
                $(document).on('click', '#saveTransaction', function(e) {
                    ...
                    try {
                        ...
                        if (account == '') account = "<?php echo e($accountName); ?>";
...
</html><?php /**PATH C:\Users\maura\financesLaravel\resources\views/transactions.blade.php ENDPATH**/ ?>